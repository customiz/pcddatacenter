  ...
  <div class="col-lg-4 col-md-6 col-12 mb-4">
    <div class="card h-100">
      <div class="card-header">
        <h3 class="card-title mb-2">ยินดีต้อนรับ John!</h3>
        <span class="d-block mb-4 text-nowrap">ระบบมีจำนวนการใช้งาน</span>
      </div>
      <div class="card-body">
        <div class="row align-items-end">
          <div class="col-6">
            <h1 class="display-6 text-primary mb-2 pt-4 pb-1">956,545</h1>
            <small class="d-block mb-3">ครั้ง </small>

          </div>
          <div class="col-6">
            <img src="{{asset('assets/img/analy.png')}}" width="140" height="150" class="rounded-start" alt="จำนวนการใช้งาน" data-app-light-img="illustrations/prize-light.png" data-app-dark-img="illustrations/prize-dark.png">
          </div>
        </div>
      </div>
    </div>
