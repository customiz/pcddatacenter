        ...
        <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-2">
          ...
          <ul class="dropdown-menu dropdown-menu-end py-0">
            <li class="dropdown-menu-header border-bottom">
              <div class="dropdown-header d-flex align-items-center py-3">
                <h5 class="text-body mb-0 me-auto">แจ้งเตือน</h5>
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item list-group-item-action dropdown-notifications-item">
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar">
                        <span class="avatar-initial rounded-circle bg-label-success"><i class='bx bxs-report'></i></span>
                      </div>
                    </div>
                    <div class="flex-grow-1">
                      <h6 class="mb-1">รายงานกำลังเผยแพร่ </h6>
                      <p class="mb-0">รายงานสภาพอากาศกำลังเผยแพร่</p>
                ...
                <li class="list-group-item list-group-item-action dropdown-notifications-item">
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar">
                        <span class="avatar-initial rounded-circle bg-label-danger"><i class='bx bxs-report'></i></span>
                      </div>
                    </div>
                    <div class="flex-grow-1">
                      <h6 class="mb-1">รายงานหมดอายุ </h6>
                      <p class="mb-0">รายงานปริมาณสารปนเปื้อนหมดอายุ</p>
